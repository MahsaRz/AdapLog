...
class MaskOnlineStep():
    # TODO: to split templates and cluster2Templates
    def __init__(self, dict_layer, templates: dict, clusters: dict, debug=False):
